...
export default function HomePage() {
  ...
  const [isSubmittingSessionSheet, setIsSubmittingSessionSheet] = useState(false);

  const [isAddClientSheetOpen, setIsAddClientSheetOpen] = useState(false);
  const [isSubmittingClientSheet, setIsSubmittingClientSheet] = useState<boolean>(false);
  ...
  const handleAddClientSubmit: SubmitHandler<InternalClientFormValues> = async (data) => {
    ...
    setIsSubmittingClientSheet(true);
    try {
      ...
      setIsSubmittingClientSheet(false);
    }
  };
    ...
    <div className="flex flex-col gap-6">
              ...
              <SheetContent className="sm:max-w-md bg-card">
                ...
                <form onSubmit={addClientForm.handleSubmit(handleAddClientSubmit)} className="space-y-4 py-4">
                  <div>
                    ...
                    <Input id="add-ownerFirstName-dash" {...addClientForm.register("ownerFirstName")} className={cn("mt-1", addClientForm.formState.errors.ownerFirstName ? "border-destructive" : "")} disabled={isSubmittingClientSheet} />
                  ...
                  <div>
                    ...
                    <Input id="add-ownerLastName-dash" {...addClientForm.register("ownerLastName")} className={cn("mt-1", addClientForm.formState.errors.ownerLastName ? "border-destructive" : "")} disabled={isSubmittingClientSheet} />
                  ...
                  <div>
                    ...
                    <Input id="add-dogName-dash" {...addClientForm.register("dogName")} className={cn("mt-1", addClientForm.formState.errors.dogName ? "border-destructive" : "")} disabled={isSubmittingClientSheet} />
                  ...
                  <div>
                    ...
                    <Input id="add-contactEmail-dash" type="email" {...addClientForm.register("contactEmail")} className={cn("mt-1", addClientForm.formState.errors.contactEmail ? "border-destructive" : "")} disabled={isSubmittingClientSheet} />
                  ...
                  <div>
                    ...
                    <Input id="add-contactNumber-dash" type="tel" {...addClientForm.register("contactNumber")} className={cn("mt-1", addClientForm.formState.errors.contactNumber ? "border-destructive" : "")} disabled={isSubmittingClientSheet} />
                  ...
                  <div>
                    ...
                    <Input id="add-postcode-dash" {...addClientForm.register("postcode")} className={cn("mt-1", addClientForm.formState.errors.postcode ? "border-destructive" : "")} disabled={isSubmittingClientSheet} />
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <Checkbox
                          ...
                          disabled={isSubmittingClientSheet}
                        />
                      )}
                    />
                  ...
                  <SheetFooter className="mt-4">
                    <SheetClose asChild>
                      <Button type="button" variant="outline" disabled={isSubmittingClientSheet}>Cancel</Button>
                    </SheetClose>
                    <Button type="submit" disabled={isSubmittingClientSheet}>
                      {isSubmittingClientSheet && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
                      Save Client
                    </Button>
                  </SheetFooter>
                </form>
                ...
                <form onSubmit={addSessionForm.handleSubmit(handleAddSessionSubmit)} className="space-y-4 py-4">
                  <div>
                    ...
                    <Controller name="clientId" control={addSessionFormControl}
                      render={({ field }) => (
                        <Select onValueChange={field.onChange} value={field.value} disabled={isSubmittingSessionSheet || isLoadingData}>
                  ...
                  <div className="grid grid-cols-4 items-start gap-4">
                    ...
                    <div className={cn("col-span-3 flex justify-center", addSessionFormErrors.date && "border-destructive border rounded-md")}>
                      <Controller name="date" control={addSessionFormControl}
                        render={({ field }) => (
                          <ShadCalendar mode="single" selected={field.value} onSelect={field.onChange} initialFocus disabled={isSubmittingSessionSheet} id="date-dashboard" className={cn("!p-1 rounded-md border", addSessionFormErrors.date && "border-destructive")}
                            classNames={{
                  ...
                  <div>
                    ...
                    <Controller name="time" control={addSessionFormControl}
                      render={({ field }) => (<Input id="time-dashboard" type="time" {...field} className={cn("w-full mt-1", addSessionFormErrors.time && "border-destructive")} disabled={isSubmittingSessionSheet} />)} />
                  ...
                  <div>
                    ...
                    <Controller name="sessionType" control={addSessionFormControl}
                      render={({ field }) => (
                        <Select onValueChange={field.onChange} value={field.value} disabled={isSubmittingSessionSheet}>
                          <SelectTrigger id="sessionType-dashboard" className={cn("w-full mt-1", addSessionFormErrors.sessionType && "border-destructive")}>
                  ...
                  <div>
                    ...
                    <Controller name="amount" control={addSessionFormControl}
                      render={({ field }) => (
                        <Input id="amount-dashboard" type="number" placeholder="e.g. 75.50" step="0.01" {...field} value={field.value === undefined ? '' : String(field.value)} onChange={e => field.onChange(e.target.value === '' ? undefined : parseFloat(e.target.value))} className={cn("w-full mt-1", addSessionFormErrors.amount && "border-destructive")} disabled={isSubmittingSessionSheet} />
                      )} />
                    {addSessionFormErrors.amount && <p className="text-xs text-destructive mt-1">{addSessionFormErrors.amount.message}</p>}
                  </div>

                  <SheetFooter className="mt-4">
                    <SheetClose asChild><Button type="button" variant="outline" disabled={isSubmittingSessionSheet}>Cancel</Button></SheetClose>
                    <Button type="submit" disabled={isSubmittingSessionSheet}>
                      {isSubmittingSessionSheet && <Loader2 className="mr-2 h-4 w-4 animate-spin" />} Save Session
                    </Button>
                  </SheetFooter>
                </form>
              </SheetContent>
          ...
          {selectedSessionForSheet && (
            <>
              ...
              <SheetFooter className="pt-4 flex flex-col sm:flex-row gap-2 sm:justify-end">
                ...
                <Button variant="destructive" onClick={() => handleDeleteSessionRequest(selectedSessionForSheet)} className="flex-1 sm:flex-none" disabled={isSubmittingSessionSheet}>{isSubmittingSessionSheet && sessionToDelete?.id === selectedSessionForSheet.id ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : <Trash2 className="mr-2 h-4 w-4" />}Delete</Button>
      ...
      <AlertDialog open={isDeleteSessionDialogOpen} onOpenChange={setIsDeleteSessionDialogOpen}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            <AlertDialogCancel onClick={() => setIsDeleteSessionDialogOpen(false)} disabled={isSubmittingSessionSheet}>Cancel</AlertDialogCancel>
            <AlertDialogAction onClick={handleConfirmDeleteSession} className="bg-destructive hover:bg-destructive/90 text-destructive-foreground" disabled={isSubmittingSessionSheet}>
              {isSubmittingSessionSheet && sessionToDelete ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : null} Confirm Delete
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
